  ...
  return (
    <div id="SideBar" className="fixed top-0 left-0 h-screen z-20">
      ...
      >
        ...
        {isOpen && (
          <>
            <h3 className="text-xl text-[#FFF6DF] font-bold text-left ml-3 pt-16 border-b-2 border-[#FF7C2B] pb-1 w-50">
              My playlists
            </h3>
            <div className="mt-4 overflow-y-auto scrollbar-hide pb-4">
              <PlayList count={20} />
            </div>
          </>
        )}
